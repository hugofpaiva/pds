...
public class Main {
	...
	private static void run(String[] command) {
		...
		switch (command[0].toLowerCase()) {
			...
			case "add":
				...
				if (command.length == 4 && Character.isDigit(command[2].charAt(0)) && Character.isDigit(command[3].charAt(0))) {
	...
	// FUNÇAO QUE APRESENTA AS POSIÇÕES DOS TERRENOS DE UMA FAMÍLIA, BEM COMO OS SEUS MEMBROS, PROCURANDO PELO NOME DE UMA PESSOA
